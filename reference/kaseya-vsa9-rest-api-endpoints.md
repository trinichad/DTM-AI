...
> **Source:** the live Swagger on the DTM tenant — `https://ks2.dtmconsulting.com/api/v1.0/swagger/ui/index`
> **Base URL:** `https://ks2.dtmconsulting.com/api/v1.0`
...
> API the DTM AI Kaseya client calls. Today we only use a handful (`/assetmgmt/assets`,
...
>
> ⚠️ **STATUS IN DTM AI:** REFERENCE ONLY. The agent reaches Kaseya only through registered tools +
