...
DTM tech sees the same conversations from any browser/device and they survive until explicitly
...
schema ports to Postgres (D-6) mechanically. Lives in the same dtm_ai.db.
"""
