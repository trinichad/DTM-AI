"""MSP AI CLI — verify the platform without the web stack.
...
def main(argv=None) -> int:
    p = argparse.ArgumentParser(prog="msp-ai", description="MSP AI operations assistant (CLI)")
    p.add_argument("--actor", default="cli@local", help="actor identity for the audit log")
