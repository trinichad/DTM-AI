"""kb_search — search the MSP AI knowledge base (Obsidian-style markdown vault)."""
...
NAME = "kb_search"
DESCRIPTION = ("Search the knowledge base: internal runbooks/SOPs PLUS bundled vendor references "
