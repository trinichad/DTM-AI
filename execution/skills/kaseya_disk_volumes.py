...
DESCRIPTION = ("Show ONE machine's disk volumes and FREE SPACE from Kaseya's hardware audit "
               "(drive letter, total size, free space, % free, format). Pass the machine name "
               "or AgentId. Use for 'is X low on disk' or 'how much free space on X'.")
SOURCE = "kaseya"
CATEGORY = "read"
RISK_LEVEL = "low"
