...
DESCRIPTION = ("Restore a previously-deleted Freshdesk ticket by `ticket_id` (un-deletes it). "
               "Pass `ticket_id` for one or `ticket_ids` (a list) to restore MANY in ONE call — "
               "do NOT call this tool once per ticket.")
SOURCE = "freshdesk"
...
PARAMETERS: dict[str, Any] = {
    ...
    "properties": {
        ...
        "ticket_ids": {"type": "array", "items": {"type": "integer"},
                       "description": "restore MANY tickets in ONE call — a list of ticket ids; "
