...
CATEGORY=write, SOURCE=msp_ai: this writes only to MSP AI's OWN delegation board, never to a client
...
PARAMETERS: dict[str, Any] = {
    "type": "object",
    "properties": {
        "title": {"type": "string", "description": "Short name for the job, e.g. 'Acme Cylance version check'."},
