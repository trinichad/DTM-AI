...
DESCRIPTION = ("Add a sender to a Proofpoint Essentials user's BLOCKED-sender list so their mail is "
               ...
               "or domain). Pass `emails` (a list) to block the SAME sender for MANY users in ONE "
               "call — do NOT call this tool once per user. Remove it later with "
               "proofpoint_remove_sender.")
SOURCE = "proofpoint"
GROUP = "proofpoint"
CATEGORY = "write"
RISK_LEVEL = "medium"
...
PARAMETERS: dict[str, Any] = {
    ...
    "properties": {
        ...
        "emails": {"type": "array", "items": {"type": "string"},
                   "description": "block the SAME sender for MANY users in ONE call — a list of "
