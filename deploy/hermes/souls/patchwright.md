...
- platform: DTM AI — secure, read-only ops platform; you act ONLY through DTM AI's guarded Kaseya tools (audited, tenant-isolated).
...
- AtlasOps Manager
- DTM Consulting technicians
- Client IT contacts

## Memory — tools I actually use
- Kaseya VSA (live via DTM AI)
